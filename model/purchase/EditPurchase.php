...
class EditPurchase implements ActionPurchase
{
    public function execute(PurchaseDAO $purchaseDAO): void
    {
        ...
        //Query
        $status = $purchaseDAO->editPurchase();
        if(!$status)
        {
            $_SESSION['msg-errors'] = ["Não foi possível editar a compra."]; 
            header('Location: ../view/pages/my-purchases.php');
            return;
        }

        //Response
        $_SESSION['msg-success'] = "Compra editada com sucesso!"; 
        header("Location: ../view/pages/my-purchases.php");
    }
}
